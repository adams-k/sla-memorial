const Thanks = () => {
    return (
        ...
        <div class="py-8 lg:py-16 px-4 mx-auto my-auto max-w-screen-md flex flex-col items-center">
            ...
            <a href="/">
                <button type="button" className="py-3 px-5 text-sm font-medium text-center text-black rounded-lg sm:w-fit focus:ring-4 focus:outline-none bg-secondary hover:bg-primary focus:ring-primary-800">Back to Home</button>
            </a>
        </div>
      </section>
    )
